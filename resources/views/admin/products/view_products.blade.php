    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom">
                    <i class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="#" class="current">View Products</a> </div>
            <h1>Products</h1>
                            ...
                            <table class="table table-bordered data-table">
                                ...
                                @foreach($products as $product)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            <a href="{{ url('/admin/edit-car/'.$product->id) }}" class="btn btn-primary btn-mini">Edit</a>
                                            <a data-id="{{$product->id}}" href="#" class="btn btn-danger btn-mini delCat">Delete</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
